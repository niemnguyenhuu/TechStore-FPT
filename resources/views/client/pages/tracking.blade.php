...
<body>
    <section class="tracking_box_area section_gap">
        <div class="container">
            <article class="card">
                <header class="card-header"> Tình trạng đơn hàng </header>
                <div class="card-body">
                    <h6>ID đơn hàng</h6>
                    <article class="card">
                        <div class="card-body row">
                            <div class="col"> <strong>Ước tính thời gian giao hàng</strong> <br>thời gian giao </div>
                            <div class="col"> <strong>Số điện thoại đặt hàng</strong><i class="fa fa-phone"></i> hê hê
                                thêm roter nè </div>
                            <div class="col"> <strong>Đơn vị vận chuyển</strong> <br> hê hê thêm roter nè </div>
                            <div class="col"> <strong>Mã đơn hàng</strong> <br> hê hê thêm roter nè </div>
                        </div>
                    </article>
                    <div class="track">
                        <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span
                                class="text">Đơn hàng đã được xác nhận</span> </div>
                        <div class="step active"> <span class="icon"> <i class="fa fa-user"></i> </span> <span
                                class="text">Đơn vị vận chuyển đã lấy hàng</span> </div> 
                        <div class="step"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span
                                class="text">Đang giao</span> </div>
                        <div class="step"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Đã
                                nhận hàng</span> </div>
                    </div>
                    <hr>
                    <ul class="row">
                    ...
                    <hr>
                    <a href="#" class="btn btn-warning" data-abc="true"> <i class="fa fa-chevron-left"></i>Quay lại giỏ
                        hàng</a>
                </div>
            </article>
        </div>
