<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div>
                <x-input-label for="file_upload" :value="__('Hình Ảnh')" />

                <x-text-input id="file_upload" class="block mt-1 w-full" type="file" name="file_upload" :value="old('file_upload')" required autofocus />
